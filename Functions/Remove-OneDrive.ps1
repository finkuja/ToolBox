...
<#
    ...
    .DESCRIPTION
    The Remove-OneDrive function uninstalls OneDrive from the system, removes leftover files and registry entries, and restores default locations for shell folders. 
...
function Remove-OneDrive {
    ...
    $confirmation = [System.Windows.Forms.MessageBox]::Show(
        "Are you sure you want to uninstall OneDrive and delete all associated files?",
        "Confirmation",
